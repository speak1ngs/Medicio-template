<section id="register " class="home-section paddingtop-130 h-100 h-custom well">
	...
	<div class="container well">
		...
		<div class="row">
			...
			<div class="col-md-4 align-self-center">
				<label for="inputState">Puntuacion</label>
				<select id="inputState" class="form-control">
					<option selected>Choose...</option>
					<option>...</option>
				</select>
			...
			<div class="row g-2 hidden-md-up ">
				<div class="col-sm-3 well bg-white">
					<div class="card card-block">
						<img class="card-img-top" alt="100%x180" src="./img/team/1.jpg" data-holder-rendered="true"
								...
								<tr>
									...
									<td>
										<p data-placement="top" data-toggle="tooltip" title="reservar"><button
												...
												data-target="#Reservar"><span class="fa fa-comments"></span></button>
										</p>
									</td>
								</tr>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-scroll">
					<div class="modal-header">
						...
						<h4 class="modal-title custom_align" id="Heading">Comentarios de fecha:21/03/2023</h4>
					</div>
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-2 col-md-4">
								<img src="./img/team/1.jpg" class="img-circle img-responsive" alt="" />
							</div>
